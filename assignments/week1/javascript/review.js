...
// masterKey = "http://wwww.maliciouswebsite.com/data";
...
parseInt("100.100"); // takes the string argument, and converts it to a number; Become 100
parseFloat("100.100") // Become 100.1
...
// Logical Operatoes and Comparison Operators
...
// ass to end and beginning. need a value in arguement.
myArray.push();
myArray.unshift();
